...
## Action Taken
 1. Assigned ticket to self and reached out to the user to confirm current status before starting diagnostics.\
    1.1. Confirmed the account itself was active (not locked/disabled).\
    1.2. narrowed issue to authenticator app being out of sync.
 2. reset the user MFA.
 3. Contact the user and inform that he can re-enroll their authenticator on next login.

## Outcome
reset MFA. Verified with user that the issue was fully resolved
